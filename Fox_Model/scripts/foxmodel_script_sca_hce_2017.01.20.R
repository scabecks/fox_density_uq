...
# Loading files from HCE Laptop
aus.r<-raster("C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/1.3_Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/aus_1_1km")
map.r<-raster("C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/1.3_Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/map_albers") ###Mean annual rainfall
mat.r<-raster("C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/1.3_Fox Model_Murphy_Legge/BrettMurphy_data_/spatial data/mat_albers") ###Mean annual temperature
cover.r<-raster("C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/1.3_Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/cover_5kmrad") ###MODIS tree cover
rugged.r<-raster("C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/1.3_Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/rugged_5kmra2") ###Ruggedness, standard deviation of elevation
fox.r<-raster("C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/1.3_Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/fox_1km")  #Fox range
mainland.r <- raster("C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/1.3_Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/isl_area_1km")
...
aus.r<-raster("D:/Software_hcaceres/Dropbox/Dropbox (UQ)/UQ_dropbox/4. Chapter 4. Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/aus_1_1km")
map.r<-raster("D:/Software_hcaceres/Dropbox/Dropbox (UQ)/UQ_dropbox/4. Chapter 4. Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/map_albers") ###Mean annual rainfall
mat.r<-raster("D:/Software_hcaceres/Dropbox/Dropbox (UQ)/UQ_dropbox/4. Chapter 4. Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/mat_albers") ###Mean annual temperature
cover.r<-raster("D:/Software_hcaceres/Dropbox/Dropbox (UQ)/UQ_dropbox/4. Chapter 4. Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/cover_5kmrad") ###MODIS tree cover
rugged.r<-raster("D:/Software_hcaceres/Dropbox/Dropbox (UQ)/UQ_dropbox/4. Chapter 4. Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/rugged_5kmra2") ###Ruggedness, standard deviation of elevation
fox.r<-raster("D:/Software_hcaceres/Dropbox/Dropbox (UQ)/UQ_dropbox/4. Chapter 4. Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/fox_1km")  #Fox range
mainland.r <- raster("D:/Software_hcaceres/Dropbox/Dropbox (UQ)/UQ_dropbox/4. Chapter 4. Fox Model_Murphy_Legge/BrettMurphy_data_/Spatial data/isl_area_1km")
mainland.r<-reclassify(mainland.r, c(-Inf,10000, 0, 10000, Inf, 1))
...
# Add in Fox Data ####
# Laptop location
foxes<- read_csv("C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/1.3_Fox Model_Murphy_Legge/Ayesha_data/Fox_densities_7Dec2016_HCE.csv",col_types = "cccnnccccnncccnnnnccccccc") %>% select(year_pub=`Year of Publication`,year_coll=`Year of Publication`,Month,lat=GDALat,long=GDALong,density=`Density (per km2)`,dingoes=`Dingoes present`)
...
write.table(di, "C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/!software_practice/temp_foxmodel_output/di_avg.csv", sep=",", row.names=F)
write.table(R2, "C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/!software_practice/temp_foxmodel_output/R2_avg.csv", sep=",", row.names=F)
...
pred.map<-p2
write.table(cbind(vary.map$map, pred.map), "C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/!software_practice/temp_foxmodel_output/predictions.map_avg.csv", sep=",", row.names=F)
...
writeRaster(mainland.density, "C:/Users/uqhcacer/Dropbox (UQ)/UQ_dropbox/!software_practice/temp_foxmodel_output/mainland_density_avg.tif", format="GTiff", overwrite=TRUE)
